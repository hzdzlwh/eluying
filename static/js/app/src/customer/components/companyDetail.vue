<template>
    <div class="noVipContent">
        ...
        <div class="noVipitem">
            ...
            <div class="noVipEntitem" v-if='data.companyType'><span class="noVipLabel">挂帐金额</span>￥{{data.ledgerFee}}<div class="dd-btn dd-btn-primary dd-btn-sm btnl" @click='showbtn3' v-if='data.ledgerFee && contral && contral.COMPANY_CHARGE_ID'>结算</div><span @click='showlistcheck' class="btnl fontbtn">结算日志</span> </div>
        </div>
        <div class="noVipitem">
