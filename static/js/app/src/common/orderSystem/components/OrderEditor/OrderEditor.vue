            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="roomModals-body">
                        ...
                        <CateEditor :order="order" v-if="this.order.type === ORDER_TYPE.CATERING || this.checkState === 'book'" :vipDiscountDetail="vipDiscountDetail" @change="handleFoodChange" @priceChange="handleFoodPriceChange">
                        </CateEditor>
