    ...
    <div>
        ...
        <div class="report-center-foot">
            <div style="float:left;">
                <span class="report-center-span">总人次 : <b>{{personCount}}</b></span>
            </div>
...
<script>
    ...
    export default {
        ...
        methods: {
            collectUrl(num) {
                if (num === 0) {
                    http.get('/stat/addToCollect', { statValue: 303 }).then(res => {
                        this.collectNum = 1;
                        this.collectName = '已收藏';
                    });
                } else if (num === 1) {
                    http.get('/stat/removeFromCollection', { statValue: 303 }).then(res => {
                        this.collectNum = 0;
