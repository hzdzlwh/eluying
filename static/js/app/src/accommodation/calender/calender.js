...
$(function(){
    ...
    shopcartService(app);
    preprocessService(app);
    orderService(app);
    app.controller('calenderCtrl', ['$rootScope', 'storeService', 'mainCalendarService', 'filterService',
        'accommodationService', 'shopcartService', 'preprocessService', 'orderService',
        function(rootScope, storeService, mainCalendarService, filterService, accommodationService, shopcartService, preprocessService, orderService) {
        //rootScope全局变量
        ...
        rootScope.changePRoomSelect = filterService.changePRoomSelect;
        rootScope.selectAllPRoom = filterService.selectAllPRoom;

        rootScope.selectDate = mainCalendarService.selectDate;
        rootScope.lastMonth = mainCalendarService.lastMonth;
        rootScope.nextMonth = mainCalendarService.nextMonth;
